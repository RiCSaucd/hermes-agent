...
Build keyless Puter.js apps with cloud AI and storage.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/web-development/puter` |
| Path | `optional-skills/web-development/puter` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
